...
var TestKeyboardBackspace = AbstractPlugin.extend({
    ...
    // BR
    {
        ...
        test: '<p>dom not to edit</p><p><br id="br-1"/><br id="br-2"/>◆<br id="br-4"/></p><p>dom not to edit</p>',
    },
    {
    ...
    },
    {
        ...
        test: '<p>dom not to edit</p><p><br id="br-1"/>◆<br id="br-4"/></p><p>dom not to edit</p>',
    },
    {
    ...
    {
        name: "in p: 2x BACKSPACE before and after br",
        content: '<p>dom to</p><p><br><br><br></p><p>edit</p>',
        steps: [{
            start: "p:eq(1)->1",
            key: 'BACKSPACE',
        }, {
        ...
        test: '<p>dom to◆<br/><br></p><p>edit</p>', // 2 BRs so that the edge BR is visible
    },
    {
        name: "in p: BACKSPACE after p with multiple br",
        content: '<p>dom to</p><p><br><br><br></p><p>edit</p>',
        steps: [{
            start: "p:eq(2)->0",
            key: 'BACKSPACE',
