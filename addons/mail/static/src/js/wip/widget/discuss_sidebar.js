...
class Sidebar extends Component {
    ...
    get quickSearchChannels() {
        ...
        return this.channels.filter(channel =>
            channel.name.toLowerCase().indexOf(this.state.quickSearchValue.toLowerCase()) !== -1);
    }
    ...
    get quickSearchDms() {
        ...
        const quickSearchValue = this.state.quickSearchValue.toLowerCase();
        return this.dms.filter(dm => {
            ...
            return name.toLowerCase().indexOf(quickSearchValue) !== -1;
        });
    }
