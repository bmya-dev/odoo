...
var KanbanActivity = BasicActivity.extend({
    ...
    fieldDependencies: _.extend({}, BasicActivity.prototype.fieldDependencies, {
        decoration_type: {type: 'selection'},
        icon: {type: 'char'}
    }),
    ...
    _render: function () {
        ...
        if (this.recordData.decoration_type) {
            $span.removeClass('fa-clock-o');
            $span.addClass('text-' + this.recordData.decoration_type + ' ' + this.recordData.icon);
        } else {
            $span.removeClass();
...
var ActivityException = AbstractField.extend({
    ...
    _renderReadonly: function () {
        if (this.value) {
            this.$el.empty();
            this.$el.addClass("pull-right text-" + this.value + " fa " + this.recordData.icon);
        }
    }
});
