...
class TestCommissions(TestCommissionsCommon):
    ...
    def test_retrocession(self):
        ...
        self.assertEqual(invoice.commission_ratio, .5, 'Commission ratio should have been forwarded to invoice')
        ...
        self.assertEqual(purchase_order.amount_total, 7.5, 'The amount on the purchase order should be 7.5 because of retrocession')
