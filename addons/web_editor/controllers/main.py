...
class Web_Editor(http.Controller):
    ...
    def _attachment_create(self, name='', datas=False, url=False, res_id=False, res_model='ir.ui.view', filters=None):
        ...
        if datas:
            ...
            raise UserError(_("You need to speficy either datas or url to create an attachment."))
