            ...
            buttons: [
                {
                    ...
                    click: function () {
                        ...
                        if (willBeContainer && !isContainer) {
                            self.$target.data('megamenuclasses', megaMenuClasses + ' o_mega_menu_container');
                        }
                        if (!willBeContainer && isContainer) {
                            self.$target.data('megamenuclasses', megaMenuClasses.replace('o_mega_menu_container', '').trim());
                        }
