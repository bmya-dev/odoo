...
class Task(models.Model):
    ...
    def write(self, vals):
        ...
        if 'parent_id' in vals and vals['parent_id']:
            fields_from_parent = self._subtask_implied_fields()
            vals.update(self._subtask_values_from_parent(vals['parent_id'], {
                k: self[k] for k in fields_from_parent      # convert self's implied fields to a dictionnary like values
            }))
    ...
    def _subtask_values_from_parent(self, parent_id, vals):
