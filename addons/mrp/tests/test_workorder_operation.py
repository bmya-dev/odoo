...
#         self.assertEqual(move_product_c.quant_ids.product_uom_id.id, kg)
    ...
    def test_planning_2(self):
        ...
        duration1 = self.operation_2.time_cycle * 100 / self.wc_alt_2.time_efficiency + self.wc_alt_2.time_start
        duration2 = 2 * self.operation_2.time_cycle * 100 / self.wc_alt_1.time_efficiency + self.wc_alt_1.time_start + self.wc_alt_1.time_stop
